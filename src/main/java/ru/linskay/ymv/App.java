...
public class App {
    ...
    public static void main(String[] args) {
        ...
        app.get("/api/play", ctx -> runCommand(ctx, () -> clickAny(
    ...
    private static void runCommand(io.javalin.http.Context ctx, Runnable command) {
        try {
            ...
            ctx.status(500).json(java.util.Map.of("status", "error", "message", e.getMessage()));
        }
    }
