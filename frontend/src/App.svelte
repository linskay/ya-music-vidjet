...
{#if booting}<div class="boot-screen"><img class="boot-logo-img" src={logo} alt="YA Music Widget" /><div class="boot-text">YA MUSIC WIDGET</div><div class="boot-line"><span></span></div></div>{/if}
